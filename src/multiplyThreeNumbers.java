/**
 * class that multiply the integers, that have 3 digits e.g. 145*123
 */
public class multiplyThreeNumbers {
    ...
    void firstLine(int[] array1, int[] array2, int[] digitOne, int[] digitTwo) {
        ...
        for (int i = array1.length - 1; i >= 0; i--) {
            multipliedNumber = array2[2] * array1[i]; // multiply last int from array2([2]) to all digits in array1
            ...
            if (i == 0) { // array to show first line
                ...
                firstLine[2] = digitOne[2]; // show the last digit
            }
        }
        System.out.print("           ");
    ...
    void secondLine(int[] array1, int[] array2, int[] digitOne, int[] digitTwo) {
        ...
        for (int i = array1.length - 1; i >= 0; i--) { // multiply second int from array2([1]) to all digits in array1
            multipliedNumber = array2[1] * array1[i];
            digitOne[i] = multipliedNumber % 10; // divide integer for 2 digits, e.g. from 12 we have 2
            multipliedNumber /= 10;
            digitTwo[i] = multipliedNumber % 10;
            ...
            if (i == 0) { // array to show second line
                ...
                secondLine[2] = digitOne[2]; // show the last digit
            }
        }
        System.out.print("          ");
    ...
    void thirdLine(int[] array1, int[] array2, int[] digitOne, int[] digitTwo) {
        ...
        for (int i = array1.length - 1; i >= 0; i--) {
            multipliedNumber = array2[0] * array1[i]; // multiply second int from array2([2]) to all digits in array1
            digitOne[i] = multipliedNumber % 10; // divide integer for 2 digits, e.g. from 12 we have 2
            multipliedNumber /= 10;
            digitTwo[i] = multipliedNumber % 10;
            ...
            if (i == 0) { // array to show third line
                ...
                thirdLine[2] = digitOne[2]; // show the last digit
            }
        }
        System.out.print("         ");
        // check if item in thirdLine is higher than 9
