/**
 * class that multiply the integers, that have 5 digits e.g. 12345*12345
 */
public class multiplyFiveNumbers {
    // multipliedNumber is sum of two digits, e.g. if we have 42 and 56, it is 6*2, 6*4, 5*2, 5*4
    ...
    void firstLine(int[] array1, int[] array2, int[] digitOne, int[] digitTwo) {
        ...
        for (int i = array1.length - 1; i >= 0; i--) {
            multipliedNumber = array2[4] * array1[i]; // multiply last int from array2([4]) to all digits in array1
            ...
            if (i == 0) { // array to show first line
                ...
                firstLine[3] = digitTwo[4] + digitOne[3];
            } else if (i == 4) {
                firstLine[4] = digitOne[4]; // show the last digit
            }
        }
        System.out.print("         ");
        // check if item in firstLine is higher than 9
    ...
    void secondLine(int[] array1, int[] array2, int[] digitOne, int[] digitTwo) {
        ...
        for (int i = array1.length - 1; i >= 0; i--) {
            multipliedNumber = array2[3] * array1[i]; // multiply fourth int from array2([3]) to all digits in array1
            digitOne[i] = multipliedNumber % 10; // divide integer for 2 digits, e.g. from 12 we have 2
            multipliedNumber /= 10;
            ...
            if (i == 0) { // array to show second line
                ...
                secondLine[0] = Integer.parseInt(nFirst); //e.g. if nFirst is higher than 9, show that 5*62345 is 311725, not 11725
                ...
                secondLine[3] = digitTwo[4] + digitOne[3];
            } else if (i == 4) {
                secondLine[4] = digitOne[4]; // show the last digit
            }
        }
        System.out.print("        ");
    ...
    void thirdLine(int[] array1, int[] array2, int[] digitOne, int[] digitTwo) {
        ...
        for (int i = array1.length - 1; i >= 0; i--) {
            ...
            if (i == 0) { // array to show third line
                ...
                thirdLine[0] = Integer.parseInt(nFirst);//e.g. if nFirst is higher than 9, show that 5*62345 is 311725, not 11725
                ...
                thirdLine[3] = digitTwo[4] + digitOne[3];
            } else if (i == 4) {
                thirdLine[4] = digitOne[4]; // show the last digit
            }
        }
        System.out.print("       ");
    ...
    void fourthLine(int[] array1, int[] array2, int[] digitOne, int[] digitTwo) {
        ...
        for (int i = array1.length - 1; i >= 0; i--) {
            multipliedNumber = array2[1] * array1[i]; // multiply second int from array2([1]) to all digits in array1
            digitOne[i] = multipliedNumber % 10; // divide integer for 2 digits, e.g. from 12 we have 2
            multipliedNumber /= 10;
            digitTwo[i] = multipliedNumber % 10;// from 12 we have 1

            if (i == 0) { // array to show fourth line
                fourthLine[0] = digitOne[0] + digitTwo[1]; // show the first digit
                String nFirst = String.valueOf(digitTwo[0] + "" + fourthLine[0]);
                fourthLine[0] = Integer.parseInt(nFirst); //e.g. if nFirst is higher than 9, show that 5*62345 is 311725, not 11725
                ...
                fourthLine[3] = digitTwo[4] + digitOne[3];
            } else if (i == 4) {
                fourthLine[4] = digitOne[4]; // show the last digit
            }
        }
        System.out.print("      ");
    ...
    /**
     * create and print fifth line of the result
     *
     * @param array1   integer array of first input parameters
     * @param array2   integer array of second input parameters
     * @param digitOne array for first divided numbers, e.g. [25,34] from input - [5,4] in digitOne[]
     * @param digitTwo array for second divided numbers, e.g. [25,34] from input - [2,3] in digitTwo[]
     */
    void fifthLine(int[] array1, int[] array2, int[] digitOne, int[] digitTwo) {
        int[] fifthLine = new int[array1.length]; // create array that show integer in fifth(last) line of multiplication
        for (int i = array1.length - 1; i >= 0; i--) {
            multipliedNumber = array2[0] * array1[i]; // multiply first int from array2([0]) to all digits in array1
            digitOne[i] = multipliedNumber % 10; // divide integer for 2 digits, e.g. from 12 we have 2
            multipliedNumber /= 10;
            digitTwo[i] = multipliedNumber % 10; //from 12 we have 1

            if (i == 0) { // array to show fifth line
                fifthLine[0] = digitOne[0] + digitTwo[1]; // show the first digit
                String nFirst = String.valueOf(digitTwo[0] + "" + fifthLine[0]);
                fifthLine[0] = Integer.parseInt(nFirst); //e.g. if nFirst is higher than 9, show that 5*62345 is 311725, not 11725
                if (fifthLine[0] > 99) { //if nFirst by adding is e.g. 310(3+10) digitTwo[0]=3 firstLine[0] = 10
                    fifthLine[0] = digitTwo[1] + digitOne[0];
                    int secondN = fifthLine[0] % 10;
                    fifthLine[0] /= 10;
                    int firstN = fifthLine[0] % 10;
                    fifthLine[0] = digitTwo[0] + firstN;
                    String nSecond = String.valueOf(fifthLine[0] + "" + secondN);
                    fifthLine[0] = Integer.parseInt(nSecond); //digit will be e.g. 411 instead of 3111
                }
            } else if (i == 1) {
                fifthLine[1] = digitTwo[2] + digitOne[1];
            } else if (i == 2) {
                fifthLine[2] = digitTwo[3] + digitOne[2];
            } else if (i == 3) {
                fifthLine[3] = digitTwo[4] + digitOne[3];
            } else if (i == 4) {
                fifthLine[4] = digitOne[4];  // show the last digit
            }
        }
        System.out.print("     ");
        // check if item in fifthLine is higher than 9
        // if yes, divide this item to 2 digits
        //if it is 13 - 3 show, and 1 add to next integer
        for (int l = fifthLine.length - 1; l >= 0; l--) {
            // and check if first number is not higher than 9 (we need to show entire first number)
            if (fifthLine[l] > 9 && l != 0) {
                int firstNumber = fifthLine[l] % 10; //get the second digit(from 12 it is 2)
                fifthLine[l] /= 10;
                int secondNumber = fifthLine[l] % 10; // get the first digit(from 12 it is 1)
                fifthLine[l] = firstNumber; // instead 12 show only 2
                fifthLine[l - 1] = fifthLine[l - 1] + secondNumber; // add 1 (from 12) to next item in the array
            }
        }
        for (int line = 0; line < fifthLine.length; line++)
            System.out.print(fifthLine[line]); //print fifth line in right order
        System.out.println();
    }
}